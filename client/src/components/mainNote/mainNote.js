...
const MainNote = (props) => (
    ...
    <div>
            ...
            <h4 style={{width:100+"%", textAlign:"center"}}>Work and save Online! or to a document on your pc! </h4> 
            ...
            <div style={{width:80+"%", textAlign:"center"}}>{props.editMode}</div>
                ...
                <textarea  readonly ={props.editable} onChange={props.handleChange.bind(this)} id="inputTextToSave" rows="35" value={props.text} style={{whiteSpace:"pre", fontFamily:"helvetica",fontWeight: props.fontWeight ,color:"black",width:100+"%", backgroundColor:props.editorBackground}}>{props.text}</textarea>
